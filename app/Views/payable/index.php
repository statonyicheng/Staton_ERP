...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="mb-0"><i class="bi bi-credit-card me-2"></i>應付帳款管理</h1>
    <div class="d-flex gap-2">
        ...
        <a href="<?= site_url('open-item/match') ?>" class="btn btn-primary">
            <i class="bi bi-check2-square me-1"></i>付款沖銷
        </a>
    </div>
</div>
    ...
    <div class="card-body">
        <form method="get" class="d-flex gap-2 flex-wrap align-items-center">
            ...
            <div class="form-check form-switch ms-2">
                ...
                <label class="form-check-label" for="showAll">含已付清</label>
            </div>
            ...
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="text-end" style="width: 11%;">應付金額</th>
                        <th class="text-end" style="width: 11%;">已付</th>
                        <th class="text-end" style="width: 11%;">未付</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if (empty($items)): ?>
                        <tr><td colspan="7" class="text-center text-muted py-5">
                            ...
                            尚無未付的應付帳款<br>
                            <small>開一張「借 費用／貸 應付…」的分錄傳票，就會出現在這裡</small>
                        </td></tr>
...
<div class="alert alert-light border mt-3 mb-4">
    ...
    <strong>付款怎麼做：</strong>
    開一張「借 應付薪資／貸 銀行存款」的分錄傳票，再到
    <a href="<?= site_url('open-item/match') ?>">立沖帳作業</a>把它與原本那筆應付勾銷。
    沖銷完這裡的未付餘額就會減少，<strong>資金餘額表也會在實際付款的月份認列這筆現金流出</strong>。
</div>
