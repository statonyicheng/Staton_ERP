...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <?php else: ?>
            ...
            <?php if ($pager['totalPages'] > 1): ?><?= view('components/pagination', ['pager' => $pager, 'baseUrl' => url_to('PayableController::index'), 'params' => ['keyword' => $keyword ?? '', 'status' => $status ?? '']]) ?><?php endif; ?>
        <?php endif; ?>
    </div>
</div>
